...
export type StorageHash =
  StorageHashBase<"cf4d8fe13d8799ca1d128f7acfd5819165953e06a800f27db1f4a8ddf7d0cbfd">;
export type ExecutionHash =
  ExecutionHashBase<"291a569517a1803923c044a639e9d0a554134127d94e257975425ed119623e51">;
          ...
          readonly table: {
            ...
            readonly readingProgress: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: "readingProgress_noteId_idx_0612c5b1";
                  readonly prefix: "readingProgress_noteId_idx";
                  readonly columns: readonly ["noteId"];
                  readonly unique: false;
                },
              ];
