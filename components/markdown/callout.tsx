...
const CALLOUT_STYLES: Record<string, string> = {
  ...
  example: "border-purple-500/50 bg-purple-500/30 text-purple-200 dark:purple-700",
  failure: "border-red-500/50 bg-red-500/30 text-red-200 dark:red-700",
  important: "border-green-500/50 bg-green-500/30 text-green-200 dark:green-700",
  ...
  question: "border-violet-500/50 bg-violet-500/30 text-violet-200 dark:violet-700",
  success: "border-emerald-500/50 bg-emerald-500/30 text-emerald-200 dark:emerald-700",
...
export function Callout({
  ...
  const className =
    CALLOUT_STYLES[normalizedType] ?? "border-border bg-muted/30 dark:border-border/80";
